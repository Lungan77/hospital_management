...
function NutritionPatientsPage() {
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-5xl font-bold text-gray-900 mb-2">Nutrition Patients</h1>
                <p className="text-gray-600 text-xl">Manage patient nutrition care</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="text-red-100 text-sm">High Risk</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold">{stats.needingAssessment}</div>
                <div className="text-yellow-100 text-sm">Need Assessment</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold">{stats.activeMealPlans}</div>
                <div className="text-green-100 text-sm">Meal Plans</div>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <div className="grid md:grid-cols-4 gap-3">
                        ...
                        {patient.pendingMeals.length > 0 && (
                          <div className="flex items-center gap-2 text-sm text-orange-600">
                            ...
                            <span>{patient.pendingMeals.length} pending</span>
                          </div>
                        )}
...
export default withAuth(NutritionPatientsPage, ["dietician", "admin"]);
