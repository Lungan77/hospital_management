              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Portable Ventilator"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="e.g., Compartment A, Shelf 2"
                  />
                </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl">
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-red-50 to-orange-50">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-red-700">Critical equipment levels detected</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="space-y-4 mb-6">
                {lowStockItems.map(([name, item], index) => (
                  <div key={index} className="p-4 bg-red-50 rounded-xl border border-red-200">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-bold text-red-900">{name}</h3>
                        <p className="text-red-700 text-sm">
                          Current: {item.quantity} | Minimum: {item.minQuantity}
                        </p>
                        {item.location && (
                          <p className="text-red-600 text-xs">Location: {item.location}</p>
                        )}
                      </div>
                      <div className="text-right">
              ...
              <div className="p-4 bg-yellow-50 rounded-xl border border-yellow-200 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm">
                      Please restock these items before your next emergency response or contact supply management.
                    </p>
                  </div>
                </div>
              </div>
