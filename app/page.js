  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 sm:w-16 sm:h-16 bg-green-600 rounded-full flex items-center justify-center shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 group animate-bounce-slow"
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gray-50 h-screen flex items-center">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <Link href="/register" className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-blue-600 text-white rounded-xl font-semibold text-base hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-blue-500/30 transform hover:scale-105">
                  Get Started Free
              ...
              <div>
                <Link href="/emergency/report" className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-red-600 text-white rounded-xl font-semibold text-base hover:bg-red-700 transition-all duration-200 shadow-lg hover:shadow-red-500/30 transform hover:scale-105 w-full sm:w-auto">
              ...
              <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-5 lg:p-6 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg border border-orange-100">
                    <span className="text-xs font-medium text-orange-800">Lab Results</span>
                    <span className="text-xl font-bold text-orange-600">12</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-100">
                    <span className="text-xs font-medium text-red-800">Staff Online</span>
                    <span className="text-xl font-bold text-red-600">48</span>
                  </div>
                </div>
              </div>
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-blue-400 rounded-full blur-2xl opacity-60 animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-cyan-400 rounded-full blur-2xl opacity-60 animate-pulse"></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 hover:-translate-y-2">
                <div className={`w-14 h-14 sm:w-16 sm:h-16 ${feature.color} rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                  {feature.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-blue-50 rounded-2xl p-6 sm:p-8 border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 hover:shadow-xl">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-semibold shadow-lg">
